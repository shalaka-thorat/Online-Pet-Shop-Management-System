...
<body> 
  ...
  <li><a href="signout.php" style="position:absolute; right:10px">Log Out</a></li>
    ...
    <div class="past_orders" id="ppoi" style="margin-top:300px">
        <form>
            <h1>Appointment Scheduled Successfully...<br>We have Sent You A Confirmation Mail On The Email ID Mentioned In Your Appointmnet Application....<br><br>
            Regards.</h1>
        </form>
    </div>
</body>
